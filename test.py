from AOCR import *
loaded_model=load_model(r'models\NN_Model.h5')
temp=0
all_chars = []
charCount=0
allwordchars=[]
...
allwordspartslens=[]
index=0
img_clean=pre_processing (r'test_image\test_15.jpg')
#img_clean=pre_processing (r'C:\Users\Lenovo\Downloads\OCR-Arabic-master\OCR-Arabic-master\test_image\test_19.jpg')
# preprocessing stage
